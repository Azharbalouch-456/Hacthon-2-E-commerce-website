...
export default function Hero6() {
  const [selectedImage, setSelectedImage] = useState("/two.png");
  const [quantity, setQuantity] = useState(1);

  const images = ["/two.png", "/two.png", "/two.png", "/two.png"];
  ...
  return (
    <div className="flex w-full gap-8 p-6 ml-14">
      ...
      <div className="w-[300px] ml-24">
        <h1 className="text-2xl font-bold">Lolito</h1>
        <p className="text-sm text-gray-500">(170 reviews) | <span className="text-green-500">In Stock</span></p>
        <p className="text-xl font-semibold text-gray-800 mt-4">Rs 7,000,000</p>
        <p className="text-sm text-gray-600 mt-2">Luxury big sofa</p>
