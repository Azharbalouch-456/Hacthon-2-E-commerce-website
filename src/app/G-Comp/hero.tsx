...
export default function GHero() {
  const [selectedImage, setSelectedImage] = useState("/1stproduct.png");
  const [quantity, setQuantity] = useState(1);

  const images = ["/1stproduct.png", "/1stproduct.png", "/1stproduct.png", "/1stproduct.png"]; // Add your image URLs here
  ...
  return (
    <div className="flex w-full gap-8 p-6 ml-14">
      ...
      <div className="w-[300px] ml-24">
        <h1 className="text-2xl font-bold">Grifo</h1>
        <p className="text-sm text-gray-500">(150 reviews) | <span className="text-green-500">In Stock</span></p>
        <p className="text-xl font-semibold text-gray-800 mt-4">Rs 1.500.000</p>
        <p className="text-sm text-gray-600 mt-2">Night Lamp</p>
