...
export default function Hero8() {
  const [selectedImage, setSelectedImage] = useState("/three.png");
  const [quantity, setQuantity] = useState(1);

  const images = ["/three.png", "/three.png", "/three.png", "/three.png"]; 
  ...
  return (
    <div className="flex w-full gap-8 p-6 ml-14">
      ...
      <div className="w-[300px] ml-24">
        <h1 className="text-2xl font-bold">Respira</h1>
        <p className="text-sm text-gray-500">(190 reviews) | <span className="text-green-500">In Stock</span></p>
        <p className="text-xl font-semibold text-gray-800 mt-4">Rs 500,000</p>
        <p className="text-sm text-gray-600 mt-2">out door bar table and stool</p>
